            ...
            for PROGRAM in "${PROGRAMS[@]}"; do
                ...
                case $PROGRAM in
                    ...
                    "spades_short" | "abyss_short")
                        ...
                        ;;
                    "spades_hybrid" | "masurca" | "abyss-hybrid")
                        ...
                        ;;
                    "polypolish" | "racon" | "racon-mp2" | "pilon")
                        PREFIX="${PROGRAM}_${SAMPLE}_NP${DEPTH_NP}_IL${DEPTH_IL}"
                        ASSEMBLY_FASTA="${ASSEMBLY_DIR}/${PREFIX}.fasta"
                        REFERENCE="-r ${ASSEMBLY_DIR}/flye-OVL1000_${SAMPLE}_NP${DEPTH_NP}.fasta"
                        # READS="--pe1 ${ILLUMINA1_FQ} --pe2 ${ILLUMINA2_FQ} --nanopore ${NANOPORE_FQ}"
                        READS=""
                        ;;
                    "reference")
...
#SBATCH --output=logs/quast/quast_${PREFIX}.out
#SBATCH --time=1-00
#SBATCH --ntasks=10
#SBATCH --mem=20GB
