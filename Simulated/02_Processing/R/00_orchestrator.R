...
results_dir <- here::here("Simulated", "02_Processing", "R", "results")
...
source(here("Simulated", "02_Processing", "R", "01_data_prep.R"))
# load("results_dir/01_data_prep.RData")

## 02_fit_models.R: Fits the models and saves the results in results_dir.
source(here("Simulated", "02_Processing", "R", "02_fit_models.R"))
load(file.path(results_dir, "02_fit_models.RData"))

## 03_figures.R: Creates the figures and saves them in results_dir/figures.
source(here("Simulated", "02_Processing", "R", "03_figures.R"))
# load(file.path(results_dir, "03_figures.RData"))

## 04_threshold_model.R: Fits the model to find the optimal threshold.
source(here("Simulated", "02_Processing", "R", "04_threshold_model.R"))
