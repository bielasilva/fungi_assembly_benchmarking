...
source /home/gas0042/miniforge3/bin/activate Busco
...
#SBATCH --output=logs/busco/busco_${PREFIX}_%j.out
#SBATCH --time=1-00
#SBATCH --ntasks=10
#SBATCH --mem=50GB
...
busco \
    ...
    --mode genome \
    --lineage_dataset ${ROOTDIR}/models/busco_downloads/lineages/fungi_odb10 \
    --download_path ${ROOTDIR}/models/busco_downloads/ \
    --offline \
    --cpu 10 --restart
